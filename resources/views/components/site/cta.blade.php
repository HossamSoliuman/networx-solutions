...
<section
    class="relative isolate overflow-hidden border-y border-white/10 bg-linear-to-br from-navy-950 via-navy-900 to-brand-900 text-white">
    <div class="bg-machine-grid absolute inset-0 -z-10 rotate-180 opacity-35"></div>
    <div class="absolute -right-20 -top-40 -z-10 size-[32rem] rounded-full bg-signal-300/10 blur-3xl"></div>
    <div class="absolute -bottom-64 left-[24%] -z-10 size-[30rem] rounded-full bg-brand-400/10 blur-3xl"></div>

    <div class="mx-auto grid max-w-[90rem] gap-10 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[1fr_auto] lg:items-end lg:px-12">
        <div data-reveal>
            <p class="section-kicker text-brand-200">Start with the requirement</p>
            <h2 class="mt-5 max-w-4xl font-display text-4xl font-bold leading-[1.02] tracking-[-0.05em] text-white sm:text-5xl lg:text-6xl">
                {{ $site['cta_title'] }}
            </h2>
            <p class="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">{{ $site['cta_intro'] }}</p>
        </div>
