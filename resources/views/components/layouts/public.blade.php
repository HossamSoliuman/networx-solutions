...
<body @class([
    ...
    <header data-site-header
        ...
        <div class="mx-auto flex h-16 max-w-[90rem] items-center justify-between gap-6 px-5 sm:px-8 lg:px-12">
            ...
            <a href="{{ route('contact') }}" data-modal-open="contact-modal" class="button-dark hidden min-h-10 px-5 py-2 lg:inline-flex">
                Get a quote
                <x-icon name="arrow-left" class="size-4 rotate-180" />
            </a>
        ...
        <nav id="site-menu" data-site-menu
            ...
            <div class="mx-auto max-w-[90rem]">
                ...
                <a href="{{ route('contact') }}" data-modal-open="contact-modal" class="button-primary mt-6 w-full">Start a project</a>
            </div>
        </nav>
    </header>
            ...
            <div class="grid gap-12 border-b border-white/10 pb-12 lg:grid-cols-[1.15fr_0.55fr_1fr_0.8fr] lg:gap-16">
                ...
                <div>
                    ...
                    <div class="mt-5 grid gap-3 text-sm">
                        ...
                        <a href="{{ route('contact') }}" data-modal-open="contact-modal" class="footer-link">Contact</a>
                    </div>
                </div>
