                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="background-color:#071429;padding:28px 32px;">
                            ...
                            <p style="margin:6px 0 0;font-size:12px;color:#8ab4ff;">Contact form notification</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <h1 style="margin:20px 0 8px;font-size:22px;color:#0f172a;">A new website enquiry was received.</h1>
                            <p style="margin:0;font-size:14px;line-height:1.7;color:#475569;">
                                Sign in to the Networx Solutions admin panel to review the enquiry.
                            </p>
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td style="padding:4px 0;">{{ $contactMessage->created_at->format('M j, Y g:i A T') }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
